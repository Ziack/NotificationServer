...
{
    public class PBKDF2EncryptionService : IEncryptionService
    {
        ...
        public string Encrypt(String original)
        {
            ...
            byte[] hash = PBKDF2(original, salt, PBKDF2_ITERATIONS, HASH_BYTES);
        ...
        public Boolean VerifyPassword(String password, String goodHash)
        {
            char[] delimiter = { ':' };
